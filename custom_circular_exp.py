...
from circular_simulation import CircularSimulation
...
parser.add_argument("--N", default=3, help="Number of agents", type=int)
...
parser.add_argument("--steps", default=7000, help="Number of steps for SGD", type=int)
...
parser.add_argument("--animate", default="True", help="Animate", type=str)
...
if __name__ == "__main__":
    ...
    ANIMATE = bool_converter(args.animate) # TRUE
    ...
    s1 = CircularSimulation(directory=directory, eta=ETA, steps=STEPS,
    ...
    for i in range(ITERATIONS):
        loss_hist = np.load(f"CollisionHist{i+1}.npy")
        avg_results += loss_hist / ITERATIONS
    print("Number of collision:", np.max(avg_results))
